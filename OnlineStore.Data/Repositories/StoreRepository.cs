...
namespace OnlineStore.Data.Repositories
{
    public class StoreRepository : IStoreRepository
    {
        ...
        public async Task<List<tblBrands>> GetAllBrands()
        {
            return await (from brand in _context.tblBrands
                          select brand).ToListAsync();
        }

        public async Task<List<tblCategory>> GetAllCategories()
        {
            return await (from brand in _context.tblCategories
                          select brand).ToListAsync();
        }

        public async Task<List<tblSupplier>> GetAllSuppliers()
        {
            return await (from brand in _context.tblSuppliers
                          select brand).ToListAsync();
        }

        public async Task<List<BrandsProducts>> GetAllBrandsProducts()
        {
            return await (from brand in _context.tblBrands
        ...
        public async Task<List<Product>> GetQuickViewProduct()
        {
            return await (from product in _context.tblProducts
        ...
        public async Task<int> SaveProduct(tblProducts tblProducts)
        {
